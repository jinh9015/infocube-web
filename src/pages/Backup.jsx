...
import { ShieldCheck, CheckCircle, Lock, Database, Cloud } from 'lucide-react';
import { motion } from 'framer-motion';
import { useLanguage } from '../context/LanguageContext';

const Backup = () => {
    const { t } = useLanguage();
    const content = t('products.backup');
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="order-2 lg:order-1 relative h-80 lg:h-96 rounded-xl overflow-hidden shadow-lg">
                            <img
                                src="https://i.dell.com/is/image/DellContent/content/dam/ss2/product-images/dell-client-products/data-protection/powerprotect-dd/dd9900/media-gallery/data-protection-powerprotect-dd9900-gallery-1.psd?fmt=png-alpha&pscan=auto&scl=1&hei=402&wid=536&qlt=100,1&resMode=sharp2&size=536,402&chrss=full"
                                alt="Data Protection"
